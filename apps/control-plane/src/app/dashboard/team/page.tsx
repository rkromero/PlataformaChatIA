          ...
          {members.map((m, idx) => {
            ...
            return (
              <div
                ...
                } ${isCurrentUser ? 'bg-brand-50/30 dark:bg-brand-500/5' : 'hover:bg-gray-50 dark:hover:bg-gray-800/50'}`}
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {isCurrentUser && (
                        <span className="rounded-md bg-brand-100 px-1.5 py-0.5 text-[10px] font-medium text-brand-700 dark:bg-brand-500/10 dark:text-brand-400">
                          Vos
                        </span>
                      )}
                    </div>
                    <div className="flex items-center gap-2">
                      {m.name && (
                        <span className="truncate text-xs text-gray-500 dark:text-gray-400">{m.email}</span>
                      )}
                    </div>
                  </div>
                </div>

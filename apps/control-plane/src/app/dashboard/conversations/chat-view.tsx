...
export function ChatView() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      <div className={`w-full flex-shrink-0 border-r border-white/[0.06] md:w-80 lg:w-96 ${mobileShowChat ? 'hidden md:block' : ''}`}>
        <ConversationList
      ...
      <div className={`flex-1 ${!mobileShowChat ? 'hidden md:flex' : 'flex'}`}>
        {selected ? (
          ...
          <div className="flex flex-1 flex-col items-center justify-center text-gray-500">
            <svg className="mb-4 h-16 w-16 text-gray-700" fill="none" viewBox="0 0 24 24" strokeWidth={0.8} stroke="currentColor">

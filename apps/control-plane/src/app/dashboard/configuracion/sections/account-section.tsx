    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <section className="card">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Mi sesión</h2>
        </div>
        <dl className="divide-y divide-gray-100 dark:divide-gray-800">
      ...
      <section className="card lg:col-span-2">
        <div className="flex items-center gap-3 mb-5">
          ...
          <h2 className="text-sm font-semibold text-gray-900 dark:text-gray-100">Configuración técnica</h2>
        </div>
        ...
        <p className="mt-4 text-xs text-gray-500 dark:text-gray-400">
          Para cambiar reglas de IA y horarios, podés hacerlo desde <span className="font-medium text-gray-700 dark:text-gray-300">Mi Bot</span>.
        </p>
      </section>
    </div>
  );
...
function ConfigCard({
  ...
  return (
    <div className="border-b border-r border-gray-100 p-4 last:border-r-0 dark:border-gray-800 sm:[&:nth-child(2n)]:border-r-0 lg:[&:nth-child(2n)]:border-r lg:[&:nth-child(4n)]:border-r-0">

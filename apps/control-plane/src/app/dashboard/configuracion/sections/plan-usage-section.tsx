  ...
  return (
    <div className="space-y-6">
      ...
      {isTrial && !isTrialExpired && (
        <div className="flex items-start gap-3 rounded-xl border border-brand-200 bg-brand-50 px-5 py-4 dark:border-brand-800 dark:bg-brand-500/10">
          <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-brand-600 dark:text-brand-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      {isTrial && isTrialExpired && (
        <div className="flex items-start gap-3 rounded-xl border border-red-200 bg-red-50 px-5 py-4 dark:border-red-800 dark:bg-red-500/10">
          <svg className="mt-0.5 h-5 w-5 flex-shrink-0 text-red-600 dark:text-red-400" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
          </svg>
          <div>
            <p className="text-sm font-semibold text-red-900 dark:text-red-100">Tu período de prueba terminó</p>
      ...
      <div>
        <h2 className="mb-4 text-base font-semibold">
          ...
          {isTrial && !isTrialExpired && (
            <span className="ml-2 text-sm font-normal text-brand-600 dark:text-brand-400">(prueba gratuita)</span>
          )}
        </h2>
        <PlanSelector

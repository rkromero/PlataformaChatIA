    ...
    >
      ...
      <div className="flex items-start gap-2">
        ...
        <button
          ...
          className="flex-shrink-0 rounded p-1 text-gray-400 hover:bg-white/[0.03]"
        >
      ...
      {expanded && (
        <div className="mt-3 space-y-2 border-t border-white/[0.06] pt-3" data-stop-nav>
          {/* Agent assignment */}
          ...
          <div className="flex gap-1.5">
            {chatwootUrl && (
              <a
                ...
                className="flex items-center gap-1 rounded-md bg-brand-500/10 px-2 py-1 text-[11px] font-medium text-brand-400 hover:bg-brand-500/20"
              >
            ...
            {whatsappUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1 rounded-md bg-emerald-500/10 px-2 py-1 text-[11px] font-medium text-emerald-400 hover:bg-emerald-500/20"
              >
            ...
            {isAdmin && (
              <button
                ...
                className="ml-auto rounded-md p-1 text-gray-400 hover:bg-red-500/10 hover:text-red-400"
                title="Eliminar lead"
              >
          ...
          <div>
            <textarea
              ...
              rows={2}
              className="w-full resize-none rounded-md border border-white/[0.06] bg-white/5 px-2 py-1.5 text-xs text-gray-300 placeholder:text-gray-500 focus:border-brand-500 focus:outline-none"
            />
          </div>

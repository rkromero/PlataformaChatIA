const FEATURES = [
  {
    ...
    description:
      'Inteligencia artificial que entiende contexto y responde como un humano. Basado en GPT-4.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Cuando el cliente dice "quiero hablar con alguien", el bot transfiere la conversación automáticamente.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Dashboard intuitivo donde gestionás tu bot, ves conversaciones y ajustás la configuración.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    title: 'Multi-negocio',
    description:
      'Cada negocio tiene su propio bot, configuración y WhatsApp. Completamente aislados.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Todas las conversaciones quedan guardadas y son buscables. Nunca pierdas el contexto de un cliente.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    description:
      'Tu bot nunca duerme. Atendé clientes a cualquier hora, incluso fines de semana y feriados.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
